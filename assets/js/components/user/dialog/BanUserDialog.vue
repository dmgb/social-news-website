        ...
        <div class="modal-header">
          <h5 class="modal-title" id="modalLabel">
            <span v-if="action === 'ban'">
              <img src="/build/images/ban.png" alt="" style="height: 2rem; width: auto;"/>
              ban user?
            </span>
            <span v-else>
              <img src="/build/images/checked.png" alt="" style="height: 2rem; width: auto;"/>
              unban user?
            </span>
          </h5>
        ...
        <div class="modal-body">
          <form method="post" @submit.prevent="banUnbanUser">
            <template v-if="action === 'ban'">
              ...
              <textarea v-show="isVisible" v-model="bannedReason" id="bannedReason" class="form-control" rows="3"
                        required></textarea>
